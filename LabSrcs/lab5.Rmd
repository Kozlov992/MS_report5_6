...
for (size in sample_size) {
  ...
  for (i in 1:length(rhos)) {
    ...
    p[[i]] <- ggplot(data.frame(dta), mapping = aes(x = X, y = Y))+ geom_point(color = "red") + stat_ellipse(color = "darkblue", size = 1.05) + labs(caption = TeX(cap)) + theme(plot.caption = element_text(hjust = 0.5, size = 20))
  }
